...
See my lesson on
[https://uodatascience.github.io/R\_Guide/0201\_Objects.html](objects)
for more detail. some examples:
...
default using
    ...
    # install.packages(c("rio", "ggplot2", "R.matlab"))
...
injected with archaerhodopsin with and without laser stimulation.
Because loading the data using `readMat` takes forever, I'll just leave
this here, unevaluated, and used a cached version of that data. This is
...
![](R_Crash_Course_files/figure-markdown_strict/unnamed-chunk-10-1.png)
...
![](R_Crash_Course_files/figure-markdown_strict/unnamed-chunk-10-2.png)
...
![](R_Crash_Course_files/figure-markdown_strict/unnamed-chunk-11-3.png)
...
![](R_Crash_Course_files/figure-markdown_strict/unnamed-chunk-11-4.png)
...
the data like this. use summarized (mean) data in that case.)
    ...
    ## 
    ## Call:
    ## lm(formula = n_spikes ~ cell, data = rep_spikes)
    ## 
    ## Residuals:
    ##     Min      1Q  Median      3Q     Max 
    ## -8.6862 -0.7643 -0.4140  0.7570 16.3138 
    ## 
    ## Coefficients:
    ##             Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)  1.24301    0.09517  13.060  < 2e-16 ***
    ## cell0 2      8.44324    0.10989  76.835  < 2e-16 ***
    ## cell0 3      1.66801    0.11179  14.921  < 2e-16 ***
    ## cell1 1      1.51059    0.11148  13.550  < 2e-16 ***
    ## cell2 1      4.65979    0.11027  42.257  < 2e-16 ***
    ## cell3 1      0.44433    0.13968   3.181 0.001470 ** 
    ## cell4 1      0.48989    0.15092   3.246 0.001173 ** 
    ## cell4 2      2.17102    0.11061  19.628  < 2e-16 ***
    ## cell5 1      1.52129    0.11077  13.733  < 2e-16 ***
    ## cell5 2      2.28004    0.10997  20.734  < 2e-16 ***
    ## cell5 3      0.21218    0.13781   1.540 0.123674    
    ## cell6 1      0.47457    0.11901   3.988 6.70e-05 ***
    ## cell6 2      0.73462    0.11395   6.447 1.17e-10 ***
    ## cell7 1      1.50737    0.11087  13.595  < 2e-16 ***
    ## cell7 2      0.35336    0.12648   2.794 0.005215 ** 
    ## cell7 3      0.48136    0.12111   3.975 7.08e-05 ***
    ## cell7 4      0.38673    0.11516   3.358 0.000786 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 2.052 on 16396 degrees of freedom
    ## Multiple R-squared:  0.5461, Adjusted R-squared:  0.5456 
    ## F-statistic:  1233 on 16 and 16396 DF,  p-value: < 2.2e-16
