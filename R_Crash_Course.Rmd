...
The most basic data class, a list, is declared with the `c()` operator. See my lesson on [https://uodatascience.github.io/R_Guide/0201_Objects.html](objects) for more detail. some examples:
```{r}
# Vector
x <- c(1,2,3,4,5,6)
x
